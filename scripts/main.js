...
$(function() {
	...
	$.getJSON("./scripts/projects.json", function (data) {
		...
		{
			$("#realisations #project-grid").append('<div class="project ' + data[index].categories + '" id="' + index + '"><div id="img" style="background-image: url(imgs/projects/' + data[index].folder + '/thumbnail.jpg)"></div><div id="text"><div id="name">' + data[index].name + '</div><div id="subtitle">' + data[index].subtitle + '</div></div></div>');
		...
		$("#realisations .project.gd").addClass("visible");
